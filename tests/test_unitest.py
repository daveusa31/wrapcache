...
from wrapcache.adapter import Sqlite3Adapter
#########################Memory test
...
class TestSqlite3Instance:
    @wrapcache.wrapcache(timeout = 3, adapter = Sqlite3Adapter)
    def test_cache(self):
        return time.time()
    ...
    @wrapcache.wrapcache(timeout = 10, adapter = Sqlite3Adapter)
    def test_input_order_cache(self, i = 1, j = 's'):
        return (time.time() + i, j)
...
class TestSqlite3Unitest(unittest.TestCase):
    def setUp(self):
        self.test_class = TestSqlite3Instance()
    ...
    def test_input_cache(self):
        ...
        time.sleep(5)
        self.assertNotEqual(self.test_class.test_input_cache(1, 'hello world'), val_1, 'test_input_cache fail')
        self.assertNotEqual(self.test_class.test_input_cache(1, 'hello world'),
                            self.test_class.test_input_cache(2, 'hello world'), 'test_input_cache fail')

    def test_input_order_cache(self):
        val_1 = self.test_class.test_input_order_cache(i=1, j='hello world')
        self.assertNotEqual(self.test_class.test_input_order_cache(j='hello world', i=1),
                            self.test_class.test_input_order_cache(j='hello wrapcache', i=1),
                            'test_input_order_cache fail')
